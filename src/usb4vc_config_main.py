...
temp_path = os.path.join(save_path, 'temp_files')
...
user_manual_button.place(x=500, y=5, width=100)
...
copy_button = Button(updates_lf, text="Copy Latest USB4VC Updates to Flash Drive", command=None, state=DISABLED)
copy_button.place(x=10, y=10, width=300)

mappings_lf = LabelFrame(root, text="Custom Gamepad Mappings", width=MAIN_WINDOW_WIDTH - PADDING*2, height=420)
